        ...
        if ( event.msg.content == "!select" ) {
            ...
            m.add_component( dpp::component().add_component(
                dpp::component()
                    ...
                    .add_select_option(
                        dpp::select_option( "Manhattan", "manhattan", "Best Borough" ).set_emoji( "🤑" ) )
                    .add_select_option(
                        dpp::select_option( "Queens", "queens", "Who even lives here" ).set_emoji( "👑" ) )
                    .add_select_option(
                        dpp::select_option( "Brooklyn", "brooklyn", "Better be Williamsburg" ).set_emoji( "☕️" ) )
                    .add_select_option(
                        dpp::select_option( "Staten Island", "staten_island", "Ok fed" ).set_emoji( "🚔" ) )
                    .set_id( "nyc_borough" ) ) );
